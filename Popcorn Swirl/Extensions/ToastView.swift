...
public class ToastView: UIView {
    ...
    private let darkBackgroundColor = UIColor(red: 0.13, green: 0.13, blue: 0.13, alpha: 1)
    private let lightBackgroundColor = UIColor(red: 0.99, green: 0.99, blue: 0.99, alpha: 1)
    ...
    /// Show on top window, if not use current VC
    public var useTopWindow = false
    ...
    private func setupConstraints() {
        ...
        let topConstraint = NSLayoutConstraint(item: self, attribute: .top, relatedBy: .equal, toItem: superview, attribute: .topMargin , multiplier: 1.2, constant: 0)
...
//    FABView.layer.shadowColor = UIColor.black.cgColor
//    FABView.layer.shadowOpacity = 0.5
